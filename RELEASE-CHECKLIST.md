...
- [x] README (badge 3.2.3 + Quick Start Intent gate)
- [x] Architecture
- [x] Workflow
- [x] Commands
- [x] Approvals
- [x] Breaking changes (no new break in 3.2.3)
- [x] Changelog (`[3.2.3] - 2026-07-30`)
- [x] Release notes `release-notes/3.2.3.md`
- [x] Example package
