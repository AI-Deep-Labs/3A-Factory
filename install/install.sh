...
REQUIRED_FILES=(
  ...
  "templates/.cursor/prompts/caveman.md:.cursor/prompts/caveman.md"
  "templates/.cursor/prompts/handoff.md:.cursor/prompts/handoff.md"
  "templates/.cursor/prompts/qa.md:.cursor/prompts/qa.md"
