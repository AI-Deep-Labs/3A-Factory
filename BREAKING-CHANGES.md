# Breaking Changes — 3.0.0 (pre-release: 3.0.0-rc.4)

Kiến trúc **Feature-local Spec Package** (greenfield). Không có migration path từ 2.x.

Áp dụng cho dòng **3.0.0**, bao gồm pre-release **`3.0.0-rc.4`** (và rc.1–rc.3).
...
- Version major line: **3.0.0** (current package: **3.0.0-rc.4**).
