...
Review độc lập toàn repo **3a-factory@3.0.0** (GA). Kiến trúc Feature-local Spec Package greenfield đã được implement (Phase 0–3, 5), document, và kiểm chứng bằng build/test/validate/installer. Phase 4 intentionally skipped.
...
README, architecture, workflow, commands, approvals, BREAKING-CHANGES, CHANGELOG, release notes, checklist, example — đầy đủ và đồng bộ version **3.0.0** GA.
...
Version **3.0.0** GA — sẵn sàng publish. Chưa publish cho đến khi user chủ động tag/push npm.
